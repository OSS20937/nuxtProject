...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<!--[--><h1 class="mb-6">기준근무시간관리</h1>`);
      ...
      _push(ssrRenderComponent(unref(VDataTable), {
        headers,
        items: unref(base_worktime_list),
        "items-per-page": 10,
        "fixed-header": ""
      }, null, _parent));
      _push(`<!--]-->`);
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/hr/base/baseWorkTimeManage.vue");
