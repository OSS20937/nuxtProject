import { computed, watchEffect, provide, inject, createVNode, mergeProps, ref, toRef, Fragment, createTextVNode, withModifiers, toDisplayString, watch, unref } from "vue";
import { p as propsFactory, F as useProxiedModel, G as clamp, s as genericComponent, H as useLocale, b as VBtn, I as defineFunctionalComponent, A as convertToUnit, J as createRange, K as deepEqual, L as wrapInArray, M as getObjectValueByPath, N as isEmpty, O as IconValue, P as makeLoaderProps, Q as useLoader, R as useBackgroundColor, v as useRender, S as LoaderSlot, i as VIcon, q as makeComponentProps, T as makeDensityProps, r as makeTagProps, x as makeThemeProps, y as provideTheme, U as useDensity, W as getPropertyFromItem, X as getCurrentInstance, Y as provideDefaults } from "../server.mjs";
import { V as VSelect } from "./VSelect-03a0285c.js";
import { e as VCheckboxBtn } from "./VCheckboxBtn-aab82c77.js";
const VDataTable$1 = "";
