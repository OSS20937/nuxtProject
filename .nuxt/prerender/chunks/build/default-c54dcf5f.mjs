import { defineComponent, createVNode, resolveDynamicComponent, unref, defineAsyncComponent, mergeProps, withCtx, renderSlot, useSSRContext } from 'file://C:/dev/MyHRVue/HR_nuxt_frontend/node_modules/.pnpm/vue@3.3.4/node_modules/vue/index.mjs';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    const DefaultLayoutWithHorizontalNav = /* @__PURE__ */ defineAsyncComponent(() => import('./DefaultLayoutWithHorizontalNav-1413dd24.mjs'));
    const DefaultLayoutWithVerticalNav = /* @__PURE__ */ defineAsyncComponent(() => import('./DefaultLayoutWithVerticalNav-a0146c4a.mjs'));
