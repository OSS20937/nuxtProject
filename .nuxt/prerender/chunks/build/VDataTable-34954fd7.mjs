import { toRef, computed, createVNode, mergeProps, Fragment, ref, watchEffect, provide, unref, watch, inject, createTextVNode, withModifiers, toDisplayString } from 'file://C:/dev/MyHRVue/HR_nuxt_frontend/node_modules/.pnpm/vue@3.3.4/node_modules/vue/index.mjs';
import { s as genericComponent, p as propsFactory, Y as provideDefaults, v as useRender, F as useProxiedModel, J as createRange, H as useLocale, L as wrapInArray, X as getCurrentInstance, K as deepEqual, b as VBtn, Q as useLoader, R as useBackgroundColor, S as LoaderSlot, y as provideTheme, U as useDensity, A as convertToUnit, W as getPropertyFromItem, M as getObjectValueByPath, N as isEmpty, G as clamp, P as makeLoaderProps, O as IconValue, I as defineFunctionalComponent, i as VIcon, x as makeThemeProps, r as makeTagProps, T as makeDensityProps, q as makeComponentProps } from './server.mjs';
import { V as VSelect } from './VSelect-03a0285c.mjs';
import { e as VCheckboxBtn } from './VCheckboxBtn-aab82c77.mjs';
...
function createHeaders(props, options) {
  ...
  watchEffect(() => {
    ...
    flat.forEach((_ref4) => {
      ...
      const key = (_a3 = column.key) != null ? _a3 : typeof column.value === "string" ? column.value : null;
      const value = (_c2 = (_b2 = column.value) != null ? _b2 : column.key) != null ? _c2 : null;
      for (let i = row; i <= row + ((_d = column.rowspan) != null ? _d : 1) - 1; i++) {
        fixedRows[i].push({
          ...column,
          key,
          value,
          fixedOffset: fixedOffsets[i],
          sortable: (_e = column.sortable) != null ? _e : key != null
        });
        fixedOffsets[i] += Number((_f = column.width) != null ? _f : 0);
      }
    });
