import { defineComponent as defineComponent$1, TransitionGroup, Transition, h, ref, computed, watch, inject as inject$1, toRaw, isRef, createVNode, getCurrentInstance as getCurrentInstance$1, unref, provide, shallowRef, nextTick, mergeProps, readonly, toRef, capitalize, camelize, warn, onScopeDispose, reactive, resolveDynamicComponent, Fragment, toRefs, resolveComponent, hasInjectionContext, watchEffect, effectScope, customRef, markRaw, isReactive, getCurrentScope, withCtx, withDirectives, toDisplayString, vShow, createBlock, openBlock, renderList, renderSlot, createTextVNode, createCommentVNode, version as version$1, Text, resolveDirective, useSSRContext, Teleport, createApp, onErrorCaptured, onServerPrefetch, defineAsyncComponent, shallowReactive, isReadonly, isShallow, Suspense } from 'file://C:/dev/MyHRVue/HR_nuxt_frontend/node_modules/.pnpm/vue@3.3.4/node_modules/vue/index.mjs';
import { $fetch } from 'file://C:/dev/MyHRVue/HR_nuxt_frontend/node_modules/.pnpm/ofetch@1.3.3/node_modules/ofetch/dist/node.mjs';
...
import { hasProtocol, parseURL, parseQuery, withTrailingSlash, withoutTrailingSlash, withQuery, isScriptProtocol, joinURL } from 'file://C:/dev/MyHRVue/HR_nuxt_frontend/node_modules/.pnpm/ufo@1.3.0/node_modules/ufo/dist/index.mjs';
...
import { PerfectScrollbar } from 'file://C:/dev/MyHRVue/HR_nuxt_frontend/node_modules/.pnpm/vue3-perfect-scrollbar@1.6.1_postcss@8.5.3/node_modules/vue3-perfect-scrollbar/dist/vue3-perfect-scrollbar.cjs.js';
import { a as useRuntimeConfig$1 } from '../_/nitro.mjs';
...
function useActivator(props, _ref) {
  ...
  getCurrentInstance("useActivator");
