import { defineComponent, createVNode, resolveDynamicComponent, unref, defineAsyncComponent, mergeProps, withCtx, renderSlot, ref, watchEffect, watch, getCurrentInstance, useSSRContext } from 'file://C:/dev/MyHRVue/HR_nuxt_frontend/node_modules/.pnpm/vue@3.3.4/node_modules/vue/index.mjs';
import { u as useSkins } from './useSkins-5d59655a.mjs';
import { composableNames } from 'file://C:/dev/MyHRVue/HR_nuxt_frontend/node_modules/.pnpm/@unhead+shared@1.11.20/node_modules/@unhead/shared/dist/index.mjs';
import { ssrRenderVNode, ssrRenderSlot } from 'file://C:/dev/MyHRVue/HR_nuxt_frontend/node_modules/.pnpm/vue@3.3.4/node_modules/vue/server-renderer/index.mjs';
import { B as useConfigStore, b8 as switchToVerticalNavOnLtOverlayNavBreakpoint, b5 as AppContentLayoutNav, b6 as injectHead, b7 as resolveUnrefHeadInput } from './server.mjs';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    const DefaultLayoutWithHorizontalNav = /* @__PURE__ */ defineAsyncComponent(() => import('./DefaultLayoutWithHorizontalNav-9489e2f8.mjs'));
    const DefaultLayoutWithVerticalNav = /* @__PURE__ */ defineAsyncComponent(() => import('./DefaultLayoutWithVerticalNav-c3426f9f.mjs'));
