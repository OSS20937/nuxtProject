import { withCtx, createTextVNode, createVNode, useSSRContext } from 'file://C:/dev/MyHRVue/HR_nuxt_frontend/node_modules/.pnpm/vue@3.3.4/node_modules/vue/index.mjs';
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs) {
  ...
  _push(ssrRenderComponent(VCard, { title: "Create Awesome \u{1F64C}" }, {
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        ...
        _push2(ssrRenderComponent(VCardText, null, {
          default: withCtx((_2, _push3, _parent3, _scopeId2) => {
            if (_push3) {
              _push3(` Chocolate sesame snaps pie carrot cake pastry pie lollipop muffin. Carrot cake drag\xE9e chupa chups jujubes. Macaroon liquorice cookie wafer tart marzipan bonbon. Gingerbread jelly-o drag\xE9e chocolate. `);
            } else {
              return [
                createTextVNode(" Chocolate sesame snaps pie carrot cake pastry pie lollipop muffin. Carrot cake drag\xE9e chupa chups jujubes. Macaroon liquorice cookie wafer tart marzipan bonbon. Gingerbread jelly-o drag\xE9e chocolate. ")
              ];
            }
          }),
          _: 1
