import { computed, toRef, createVNode, mergeProps, shallowRef, ref } from 'file://C:/dev/MyHRVue/HR_nuxt_frontend/node_modules/.pnpm/vue@3.3.4/node_modules/vue/index.mjs';
import { s as genericComponent, p as propsFactory, F as useProxiedModel, U as useDensity, R as useBackgroundColor, Y as provideDefaults, v as useRender, A as convertToUnit, z as useTextColor, b as VBtn, r as makeTagProps, T as makeDensityProps, aW as isObject, t as useRtl, aB as useDisplay, am as useGroup, aA as useResizeObserver, aV as VFadeTransition, i as VIcon, aj as omit, aU as makeVBtnProps, a7 as animate, ab as standardEasing, ak as makeGroupProps, q as makeComponentProps, O as IconValue, G as clamp, aS as focusableChildren } from './server.mjs';
    ...
    useRender(() => {
      ...
      return createVNode(VBtn, mergeProps({
        ...
        default: () => {
          var _a2;
          var _a;
          return [(_a2 = (_a = slots.default) == null ? void 0 : _a.call(slots)) != null ? _a2 : props.text, !props.hideSlider && createVNode("div", {
            "ref": sliderEl,
