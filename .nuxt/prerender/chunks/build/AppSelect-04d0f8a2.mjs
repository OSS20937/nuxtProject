  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({
        class: ["app-select flex-grow-1", _ctx.$attrs.class]
      }, _attrs))}>`);
      if (unref(label)) {
      ...
      _push(ssrRenderComponent(VSelect, {
        ...
        variant: "outlined",
        id: unref(elementId),
        menuProps: { contentClass: ["app-inner-list", "app-select__content", "v-select__content", _ctx.$attrs.multiple !== void 0 ? "v-list-select-multiple" : ""] }
      }, createSlots({ _: 2 }, [
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("@core/components/app-form-elements/AppSelect.vue");
